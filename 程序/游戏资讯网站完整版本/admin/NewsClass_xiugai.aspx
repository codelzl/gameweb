<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsClass_xiugai.aspx.cs" Inherits="admin_NewsClass_xiugai" %>
...
<body class="Body">
  ...
  style="BACKGROUND-IMAGE: url(images/bg_header.gif); BACKGROUND-REPEAT: repeat-x">
        ...
        <TD><SPAN 
                ...
                style="padding: 10px; FLOAT: left; BACKGROUND-IMAGE: url('images/main_hb.gif'); COLOR: white; BACKGROUND-REPEAT: repeat-x; HEIGHT: 13px; TEXT-ALIGN:">编辑分类</SPAN><SPAN 
  ...
  <tr>
    <td colspan="2" align="center" class="Login1" height="25">编辑分类</td>
  </tr>
  <tr>
